        ...
        <div className="mx-auto max-w-7xl px-6 h-20 flex items-center justify-between gap-8">
          ...
          <nav className="hidden md:flex items-center gap-8 text-xs uppercase tracking-[0.2em] text-muted-foreground">
            ...
            <div className="group relative">
              <Link to="/shop" className="hover:text-foreground transition-colors py-6">Shop</Link>
              <div className="invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all absolute left-1/2 top-full -translate-x-1/2 w-[640px] bg-background border border-border/60 shadow-xl p-8 grid grid-cols-2 gap-8">
                <div>
