  ...
  component: () => (
    ...
    >
      ...
      <section>
        ...
        <p>Send a short note about your studio or space, the project in mind, and what drew you to Zolvex to <a target="_top" href="mailto:zolvex.business@gmail.com" className="underline underline-offset-4">zolvex.business@gmail.com</a>. We answer every enquiry personally.</p>
      </section>
    </PageShell>
  ),
});
