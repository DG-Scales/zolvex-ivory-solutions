...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://zolvexlighting.com/__l5e/assets-v1/1846088b-1f18-4f42-8258-63676567670b/zolvex-og.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "1200" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://zolvexlighting.com/__l5e/assets-v1/1846088b-1f18-4f42-8258-63676567670b/zolvex-og.png" },
    ],
    links: [{ rel: "canonical", href: "https://zolvexlighting.com/" }],
  }),
  component: Index,
});
