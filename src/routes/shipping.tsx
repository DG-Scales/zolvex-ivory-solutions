...
export const Route = createFileRoute("/shipping")({
  ...
  component: () => (
    <PageShell eyebrow="Support" title="Shipping" lead="We ship lighting worldwide. Orders leave our warehouse within 1–4 business days; made-to-order pieces follow the lead time on the product page.">
      ...
      <section><h2 className="font-display text-2xl mb-3">International (could take up to 60 days under certain circumstances)</h2><p>7–25 business days depending on destination. Fixtures ship with wiring compliant to your destination region.</p></section>
