...
export const Route = createFileRoute("/shipping")({
  ...
  component: () => (
    <PageShell eyebrow="Support" title="Shipping" lead="We ship lighting worldwide. Orders leave our warehouse within 1–4 business days; made-to-order pieces follow the lead time on the product page.">
      <section><h2 className="font-display text-2xl mb-3">United States</h2><p>Standard shipping: 10–25 business days. Free on orders over $150. Oversized chandeliers and exterior fixtures may require freight delivery — calculated at checkout.</p></section>
