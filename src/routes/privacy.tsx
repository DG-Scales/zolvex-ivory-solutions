...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How Zolvex collects, uses, and protects your personal information." },
      ...
      <main className="flex-1 mx-auto max-w-3xl px-6 py-20 md:py-28 w-full">
        ...
        <div className="space-y-10 text-foreground/90 leading-relaxed">
          <section className="space-y-4">
            <p>
              Zolvex operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the "Services"). Zolvex is powered by Shopify, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
            </p>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl mb-3">Personal Information We Collect or Process</h2>
            <p className="mb-3">
            ...
            <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
              <li><span className="text-foreground/90">Contact details</span> including your name, address, billing address, shipping address, phone number, and email address.</li>
              <li><span className="text-foreground/90">Financial information</span> including credit card, debit card, and financial account numbers, payment card information, financial account information, transaction details, form of payment, payment confirmation and other payment details.</li>
              <li><span className="text-foreground/90">Account information</span> including your username, password, security questions, preferences and settings.</li>
              <li><span className="text-foreground/90">Transaction information</span> including the items you view, put in your cart, add to your wishlist, or purchase, return, exchange or cancel and your past transactions.</li>
              <li><span className="text-foreground/90">Communications with us</span> including the information you include in communications with us, for example, when sending a customer support inquiry.</li>
              <li><span className="text-foreground/90">Device information</span> including information about your device, browser, or network connection, your IP address, and other unique identifiers.</li>
              <li><span className="text-foreground/90">Usage information</span> including information regarding your interaction with the Services, including how and when you interact with or navigate the Services.</li>
            </ul>
          </section>

          <section>
            <h2 className="font-display text-2xl mb-3">Personal Information Sources</h2>
            <p className="mb-3">We may collect personal information from the following sources:</p>
            <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
              <li><span className="text-foreground/90">Directly from you</span> including when you create an account, visit or use the Services, communicate with us, or otherwise provide us with your personal information;</li>
              <li><span className="text-foreground/90">Automatically through the Services</span> including from your device when you use our products or services or visit our websites, and through the use of cookies and similar technologies;</li>
              <li><span className="text-foreground/90">From our service providers</span> including when we engage them to enable certain technology and when they collect or process your personal information on our behalf;</li>
              <li><span className="text-foreground/90">From our partners or other third parties.</span></li>
            </ul>
          </section>

          <section>
            <h2 className="font-display text-2xl mb-3">How We Use Your Personal Information</h2>
            ...
            <ul className="list-disc pl-5 space-y-3 text-muted-foreground">
              <li><span className="text-foreground/90">Provide, Tailor, and Improve the Services.</span> We use your personal information to provide you with the Services, including to perform our contract with you, to process your payments, to fulfill your orders, to remember your preferences and items you are interested in, to send notifications to you related to your account, to process purchases, returns, exchanges or other transactions, to create, maintain and otherwise manage your account, to arrange for shipping, to facilitate any returns and exchanges, to enable you to post reviews, and to create a customized shopping experience for you, such as recommending products related to your purchases. This may include using your personal information to better tailor and improve the Services.</li>
              <li><span className="text-foreground/90">Marketing and Advertising.</span> We use your personal information for marketing and promotional purposes, such as to send marketing, advertising and promotional communications by email, text message or postal mail, and to show you online advertisements for products or services on the Services or other websites, including based on items you previously have purchased or added to your cart and other activity on the Services.</li>
              <li><span className="text-foreground/90">Security and Fraud Prevention.</span> We use your personal information to authenticate your account, to provide a secure payment and shopping experience, detect, investigate or take action regarding possible fraudulent, illegal, unsafe, or malicious activity, protect public safety, and to secure our services. If you choose to use the Services and register an account, you are responsible for keeping your account credentials safe. We highly recommend that you do not share your username, password or other access details with anyone else.</li>
              <li><span className="text-foreground/90">Communicating with You.</span> We use your personal information to provide you with customer support, to be responsive to you, to provide effective services to you and to maintain our business relationship with you.</li>
              <li><span className="text-foreground/90">Legal Reasons.</span> We use your personal information to comply with applicable law or respond to valid legal process, including requests from law enforcement or government agencies, to investigate or participate in civil discovery, potential or actual litigation, or other adversarial legal proceedings, and to enforce or investigate potential violations of our terms or policies.</li>
            </ul>
          </section>

          <section>
            <h2 className="font-display text-2xl mb-3">How We Disclose Personal Information</h2>
          ...
          <section>
            <h2 className="font-display text-2xl mb-3">Relationship with Shopify</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl mb-3">Third Party Websites and Links</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl mb-3">Children's Data</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="font-display text-2xl mb-3">Security and Retention of Your Information</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl mb-3">Your Rights and Choices</h2>
            <p className="mb-3">
              Depending on where you live, you may have some or all of the rights listed below in relation to your personal information. However, these rights are not absolute, may apply only in certain circumstances and, in certain cases, we may decline your request as permitted by law.
            </p>
            <ul className="list-disc pl-5 space-y-3 text-muted-foreground">
              <li><span className="text-foreground/90">Right to Access / Know.</span> You may have a right to request access to personal information that we hold about you.</li>
              <li><span className="text-foreground/90">Right to Delete.</span> You may have a right to request that we delete personal information we maintain about you.</li>
              <li><span className="text-foreground/90">Right to Correct.</span> You may have a right to request that we correct inaccurate personal information we maintain about you.</li>
              <li><span className="text-foreground/90">Right of Portability.</span> You may have a right to receive a copy of the personal information we hold about you and to request that we transfer it to a third party, in certain circumstances and with certain exceptions.</li>
              <li><span className="text-foreground/90">Right to Opt out of Sale or Sharing for Targeted Advertising.</span> Depending on where you reside, you may have a right to opt out of the "sale" or "share" of your personal information or to opt out of the processing of your personal information for purposes considered to be "targeted advertising", as defined in applicable privacy laws. Please note that if you visit our website with the Global Privacy Control opt-out preference signal enabled, depending on where you are, we will automatically treat this as a request to opt-out for the device and browser that you use to visit the website. If we are able to associate the device sending the signal to a Shopify account, we will apply the opt out request to the account as well. To learn more about Global Privacy Control, you can visit <a target="_top" href="https://globalprivacycontrol.org/" className="underline underline-offset-4">https://globalprivacycontrol.org/</a>. Other than the Global Privacy Control, we do not recognize other "Do Not Track" signals that may be sent from your web browser or device.</li>
              <li><span className="text-foreground/90">Managing Communication Preferences.</span> We may send you promotional emails, and you may opt out of receiving these at any time by using the unsubscribe option displayed in our emails to you. If you opt out, we may still send you non-promotional emails, such as those about your account or orders that you have made.</li>
            </ul>
            <p className="mt-4">If you reside in the UK or European Economic Area, and subject to exceptions and limitations provided by local law, you may exercise the following rights in addition to the rights outlined above:</p>
            <ul className="list-disc pl-5 space-y-3 text-muted-foreground">
              <li><span className="text-foreground/90">Objection to Processing and Restriction of Processing:</span> You may have the right to ask us to stop or restrict our processing of personal information for certain purposes.</li>
              <li><span className="text-foreground/90">Withdrawal of Consent:</span> Where we rely on consent to process your personal information, you have the right to withdraw this consent. If you withdraw your consent, this will not affect the lawfulness of any processing based on your consent before its withdrawal.</li>
            </ul>
            <p className="mt-4">
              You may exercise any of these rights where indicated on the Services or by contacting us using the contact details provided below. To learn more about how Shopify uses your personal information and any rights you may have, including rights related to data processed by Shopify, you can visit <a target="_top" href="https://privacy.shopify.com/en" className="underline underline-offset-4">https://privacy.shopify.com/en</a>.
            </p>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl mb-3">Complaints</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="font-display text-2xl mb-3">International Transfers</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-2xl mb-3">Changes to This Privacy Policy</h2>
            <p>
