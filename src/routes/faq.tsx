...
const faqs = [
  ...
  { q: "Can I change or cancel my order?", a: "Email notify@zolvex.org within 24 hours of placing your order and we'll do our best." },
  { q: "Do you offer trade pricing?", a: "Yes — we work with designers, architects, and hospitality. See our Wholesale page or email notify@zolvex.org." },
];
...
export const Route = createFileRoute("/faq")({
  ...
  component: () => (
    <PageShell eyebrow="Support" title="Frequently asked" lead="Quick answers. If yours isn't here, email notify@zolvex.org.">
      {faqs.map((f) => (
